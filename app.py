...
# from langchain_community.vectorstores import FAISS
# from langchain_groq import ChatGroq
# from langchain_classic.memory import ConversationBufferMemory        # ✅ fixed
# from langchain_classic.chains import ConversationalRetrievalChain   # ✅ fixed
# from dotenv import load_dotenv
...
# if uploaded_file:
#     with st.spinner("Reading and indexing your PDF..."):
#         faissdb = build_vectorstore(uploaded_file.read())
...
#     col1, col2 = st.columns([1, 1])
#     with col1:
#         submit = st.button("Submit", disabled=not query)
#     with col2:
